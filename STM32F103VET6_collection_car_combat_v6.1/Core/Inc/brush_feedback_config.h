...
#endif
#define BRUSH_ENCODER_SIGN 1 /* Swap A/B or use -1 if forward RPM is negative. */
#ifndef BRUSH_AUTO_ENABLE_ON_BOOT
#define BRUSH_AUTO_ENABLE_ON_BOOT 0U /* After calibration, E arms, O disarms. */
#endif
...
#define BRUSH_AUTO_MAX_ATTEMPTS 2U
